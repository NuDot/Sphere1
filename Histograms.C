...
void Histograms(){
  ...
  std::string out = "/u/nobackup/lwinslow/elagin/Sphere1/Sphere1-build/output/Plots";
  ...
  Hits_Tree->ReadFile("/u/nobackup/lwinslow/elagin/Sphere1/Sphere1-build/output/photon_hits.txt","x_hit:y_hit:z_hit:cos_theta:photon_wavelength:true_time:PE_creation:PE_time:detection_coverage_included:true_time_corrected:PE_time_corrected:cos_theta_reco:theta_reco:phi_reco:process:eventID");
  Events_Tree->ReadFile("/u/nobackup/lwinslow/elagin/Sphere1/Sphere1-build/output/events.txt","eventID_ET:Nprimaries:pos_x:pos_y:pos_z:fake_x:fake_y:fake_z:pdg1:Ekin1:dir_x1:dir_y1:dir_z1:pdg2:Ekin2:dir_x2:dir_y2:dir_z2:Npe:forward_hits:backward_hits");
  ...
  //-----------------------------------------------------------------------------------------------------------------------
  //
  TFile *tf = new TFile("/u/nobackup/lwinslow/elagin/Sphere1/Sphere1-build/output/output_1el_1p4MeV_m4500mm_100.root","recreate");
